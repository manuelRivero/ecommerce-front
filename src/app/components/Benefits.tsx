...
const Benefits = () => {
  ...
  const benefits = [
    ...
    },
    {
      ...
      metrics: ['Catálogo ilimitado', 'Gestión de stock', 'Promociones automáticas'],
      color: 'primary',
    },
    {
      ...
      metrics: ['100% responsive', 'Optimizado móvil', 'Navegación táctil'],
      color: 'secondary',
    },
    {
      icon: <Cloud sx={{ fontSize: 40, color: 'info.main' }} />,
      title: 'Escalabilidad Automática',
      description: 'Crece con tu negocio sin preocuparte por la infraestructura técnica.',
      metrics: ['Escalado automático', 'Alta disponibilidad', 'Backup automático'],
      color: 'info',
    },
  ];
